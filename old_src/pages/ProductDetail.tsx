      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="w-full lg:w-3/5 flex flex-col md:flex-row gap-4">
          ...
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            key={activeImage}
            className="flex-1 aspect-[3/4] bg-stone-200 overflow-hidden"
          >
            <img 
        ...
        <div className="w-full lg:w-2/5 flex flex-col pt-8">
          ...
          <div className="space-y-8 mb-12">
            <p className="font-light tracking-wide leading-relaxed text-charcoal/80">
              {product.description}
            </p>
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-4">
                ...
                <button 
                  ...
                  className="text-xs tracking-wide underline text-charcoal/60 hover:text-charcoal transition-colors"
                >
                  Guía de tallas
                </button>
              </div>
              <div className="grid grid-cols-4 gap-4">
                {SIZES.map(size => (
                  <button
                    ...
                    className={`py-3 text-sm border font-medium ${
                      selectedSize === size 
                        ? 'border-charcoal bg-charcoal text-white' 
                        : 'border-charcoal/20 hover:border-charcoal transition-colors'
                    }`}
                  >
                    {size}
                  </button>
          ...
          <button 
            onClick={() => addToCart(product, isOneSize ? 'Única' : selectedSize)}
          ...
          <a
            href={`https://wa.me/573103068584?text=${encodeURIComponent(`Hola, vi el producto *${product.name}* y me gustaría pedirte información.`)}`}
            target="_blank"
          ...
          <div className="border-t border-charcoal/10 pt-6 space-y-4">
            ...
            <p className="text-sm font-light text-charcoal/70 leading-relaxed">
              Trabajamos mediante pago por <strong>transferencia bancaria</strong>. 
              Puedes hacer tu pedido en la web o contactándonos directamente vía WhatsApp para recibir los datos de transferencia.
            </p>
          </div>
        </div>
      </div>
