      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 md:bottom-auto md:top-1/2 left-0 w-full md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-2xl bg-sand z-50 rounded-t-2xl md:rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
          >
            ...
            <div className="p-6 overflow-y-auto">
              <p className="text-sm font-light text-charcoal/80 mb-6">
                Todas nuestras prendas están diseñadas pensando en la comodidad. Usa esta tabla como referencia para encontrar tu talla ideal. Las medidas están en centímetros (cm).
              </p>
                ...
                <table className="w-full text-sm text-left border-collapse min-w-[500px]">
                  <thead>
                    <tr className="border-b border-charcoal/20">
                      <th className="py-3 px-4 font-semibold uppercase tracking-widest text-xs">Talla</th>
                      <th className="py-3 px-4 font-semibold uppercase tracking-widest text-xs">Busto</th>
                      <th className="py-3 px-4 font-semibold uppercase tracking-widest text-xs">Cintura</th>
                      <th className="py-3 px-4 font-semibold uppercase tracking-widest text-xs">Cadera</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
              ...
              <div className="mt-8 p-4 bg-[#25D366]/10 text-[#25D366] rounded-xl text-sm flex gap-3 items-start">
                ...
                <p>
                  <strong>¿Aún tienes dudas?</strong><br/>
                  Al ser prendas artesanales, también hacemos ajustes personalizados. Escríbenos a WhatsApp y te asesoraremos personalmente con tu talla ideal.
                </p>
              </div>
            </div>
          </motion.div>
